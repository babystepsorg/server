...
exports.createOrUpdateOvulation = exports.getGentleReminderDoc = exports.createOrUpdateGR = exports.deleteOne = exports.updateOne = exports.createOne = exports.getAll = void 0;
...
const ovulation_1 = require("../../models/ovulation");
const getAll = async (req, res, next) => {
    ...
    let { week } = await (0, week_1.getWeekFromUser)(req.user, req.query?.week ? +req.query.week : undefined);
    let days = (0, week_1.getDaysOfWeekForWeek)({ weekNumber: week, createdAt: new Date(userCreationDate) });
    if (userConsiveDate) {
        days = (0, week_1.getDaysOfWeekForWeek)({ weekNumber: week, consiveDate: new Date(userConsiveDate) });
    }
    if (req.query.week) {
    ...
    try {
        ...
        const ovulation = await ovulation_1.Ovulations.findOne({ userId: req.user._id });
...
const createOrUpdateOvulation = async (req, res, next) => {
    try {
        const ovulation = await ovulation_1.Ovulations.findOneAndUpdate({ userId: req.user._id }, { $set: { ...req.body, } }, { upsert: true });
        if (!ovulation.ok) {
...
exports.createOrUpdateOvulation = createOrUpdateOvulation;
